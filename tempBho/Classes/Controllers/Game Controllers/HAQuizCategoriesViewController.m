...
- (void)adjustCategoriesTableFrameOnRemovingAds
{
    if ([[HASettings sharedManager] requiredAdDisplay] == YES)
    {
        self._quizCategoriesTableView.frame = CGRectMake(self._quizCategoriesTableView.frame.origin.x, self._quizCategoriesTableView.frame.origin.y, self._quizCategoriesTableView.frame.size.width, self.view.frame.size.height - 70.0);
    }
    else{
        self._quizCategoriesTableView.frame = CGRectMake(self._quizCategoriesTableView.frame.origin.x, self._quizCategoriesTableView.frame.origin.y, self._quizCategoriesTableView.frame.size.width, self.view.frame.size.height);
    }
}
